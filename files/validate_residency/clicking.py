...
while True:
    ...
    validation_button = driver.find_element(By.XPATH, "//div[contains(@class, 'Checkbox-wrapper AccountValidation-wrapper')]//i[contains(@class, 'xpl-toggle')]//input[@type='checkbox']")
    print("found it")
