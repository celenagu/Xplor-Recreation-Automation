            ...
            try: 
                ...
                for index in range(len(clients)):
                    try: 
                        ...
                        # Handle owner validation error
                        owner_dropdown_element = driver.find_element("xpath", "//select[contains(@class, 'pmuserpicker')]")
                        owner_dropdown = Select(owner_dropdown_element)
                        owner_dropdown.select_by_visible_text("PM Support")
